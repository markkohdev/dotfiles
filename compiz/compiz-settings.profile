...
[core]
s0_active_plugins = core;composite;opengl;regex;grid;imgpng;commands;resize;snap;place;compiztoolbox;unitymtgrabhandles;move;copytex;animation;mousepoll;vpswitch;wall;put;session;expo;fade;workarounds;ezoom;scale;unityshell;
...
s0_put_next_output_key = <Control><Alt><Super>Right
